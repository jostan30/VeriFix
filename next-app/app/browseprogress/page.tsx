...
export default function BrowseProgress() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      {/* NAVIGATION HEADER */}
      <header className="fixed top-0 w-full z-50 bg-white/70 backdrop-blur-xl border-b border-white/20 shadow-lg shadow-black/5">
          ...
          <div className="flex items-center justify-between h-18">
            ...
            >
              <div className="relative">
                <div className="w-12 h-12 bg-gradient-to-br from-violet-500 via-purple-500 to-blue-500 rounded-2xl flex items-center justify-center shadow-lg shadow-violet-500/25">
                  <span className="text-white font-bold text-2xl">C</span>
                </div>
                <div className="absolute -top-1 -right-1 w-4 h-4 bg-gradient-to-r from-green-400 to-emerald-500 rounded-full animate-pulse"></div>
              </div>
              <div>
                <span className="font-black text-3xl bg-gradient-to-r from-violet-600 via-purple-600 to-blue-600 bg-clip-text text-transparent">
                  CivicVerify
                </span>
                <div className="text-xs text-slate-500 font-medium">Community Platform</div>
              </div>
            </motion.div>
            ...
            {/* Mobile Menu Button */}
            <motion.button
              className="lg:hidden p-3 rounded-xl hover:bg-violet-50 transition-colors"
              ...
              <nav className="px-6 py-6 space-y-1">
                {['Home', 'Report', 'Browse', 'Dashboard', 'Community'].map((item, index) => (
                  <motion.a
                    key={item}
                    href={`/${item.toLowerCase()}`}
                    className="block py-3 px-4 text-slate-600 hover:text-violet-600 hover:bg-violet-50 font-semibold rounded-xl transition-all"
