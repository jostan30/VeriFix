...
const Navigation = ({ darkMode }: { darkMode: boolean }) => {
...
const GlowingCard = ({
  ...
  return (
    ...
    >
      <div className={`absolute -inset-0.5 bg-gradient-to-r ${glowClasses[glowColor]} rounded-xl opacity-0 group-hover:opacity-20 transition duration-500 blur`} />
