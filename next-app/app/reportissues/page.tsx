        ...
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <div className="flex items-center space-x-2">
              <motion.button
                whileHover={{ scale: 1.1 }}
                className="p-2 text-slate-600 dark:text-slate-300 hover:text-teal-600 dark:hover:text-teal-400"
              >
                <Bell className="h-5 w-5" />
              </motion.button>
              <div className="w-8 h-8 bg-gradient-to-br from-teal-500 to-blue-500 rounded-full"></div>
            </div>
          </nav>
